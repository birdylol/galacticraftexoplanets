package net.birdylol.gcexoplanets.objects.celestialbodies.kapteynsystem.b.sky;
...
public class SkyProviderKapteynb extends SkyProviderBase
{
	private static final ResourceLocation test = new ResourceLocation("gcexoplanets:textures/gui/celestialbodies/kapteyn/kstar.png");
	...
	protected void rendererSky(Tessellator tessellator, BufferBuilder worldRenderer, float f10, float ticks) {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.test);
	...
	protected ResourceLocation sunImage() {
		return new ResourceLocation("gcexoplanets:textures/gui/celestialbodies/kapteyn/kstar.png");
	}
